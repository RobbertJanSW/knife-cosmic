...
The easiest way to accomplish this is to create some entries in your <tt>knife.rb</tt> file:
    ...
    knife[:cosmic_url] = "http://yourcosmicserver.com:8080/client/api
...
<tt>-A</tt> (or <tt>--cosmic-api-key </tt>) <tt>-K</tt> (or <tt>--cosmic-secret-key</tt>) command options
    ...
    knife cs server create my-server -r 'role[webserver]' -S "small" -T "RHEL 5.6 Base" -A 'Your cosmic API Key' -K "Your cosmic Secret Key" --distro "rhel5-gems"
...
(Ref. http://cosmic.apache.org/docs/api/apidocs-4.0.0/root_admin/createIpForwardingRule.html)
